...
sed -i 's/>//g' UBE03_NT003; sed -i 's/\t$//g' UBE03_NT003; sed -i 's/;START//g' UBE03_NT003; sed -i 's/;END//g' UBE03_NT003; sed -i 's/;/\t/g' UBE03_NT003; sort -V -u -k 10,10 UBE03_NT003 > UBE03_NT004; ## > MERGE3
